...
# Load data
data_path = "C:/Users/klacourse/Documents/NGosselin/data/edf/RBD/13_second_subjects/"
LOC_label = 'LOC'
ROC_label = 'ROC'
...
for i_subject in subject_label:
    ...
    raw = mne.io.read_raw_edf(f"{data_path}{i_subject}.edf", preload=True)
    ...
    loc = raw._data[0,:] * 1e6
    roc = raw._data[1,:] * 1e6
    rem = yasa.rem_detect(loc, roc, sf, hypno=hypno_up, include=5, amplitude=(REM_amplitude_det, 325), duration=(0.3, 1.5), \
